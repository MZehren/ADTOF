...
def main():
    ...
    for algoName in meanResults:
        ...
        print(
            "sum fm",
            getF(
                np.sum([pitch["TP"] for pitch in sumResults[algoName].values()]),
                np.sum([pitch["FP"] for pitch in sumResults[algoName].values()]),
                np.sum([pitch["FN"] for pitch in sumResults[algoName].values()]),
            )[0],
        )
        ...
        print("sum KD fm", getF(sumResults[algoName][36]["TP"], sumResults[algoName][36]["FP"], sumResults[algoName][36]["FN"])[0])
        print("mean SD fm", np.mean(meanResults[algoName][40]["F"]))
        print("sum SD fm", getF(sumResults[algoName][40]["TP"], sumResults[algoName][40]["FP"], sumResults[algoName][40]["FN"])[0])
        print("mean HH fm", np.mean(meanResults[algoName][46]["F"]))
        print("sum HH fm", getF(sumResults[algoName][46]["TP"], sumResults[algoName][46]["FP"], sumResults[algoName][46]["FN"])[0])

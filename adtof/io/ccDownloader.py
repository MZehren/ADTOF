...
def scrapIndex(rangeToParse=range(0, 1), perPage=50, path="/home/mickael/Documents/Datasets/drumsTranscription/ADTOF/raw/c3Download/"):
    for i in rangeToParse:
        logging.info("page :" + str(i))
        url = "http://customscreators.com/index.php?/page/index.html?sort_col=rating_value&sort_order=desc&per_page=" + str(
            perPage
        ) + "&filters%5B18%5D%5B1%2C2%2C3%2C4%2C5%2C6%2C7%5D=1&filters%5B23%5D%5B1%2C2%2C3%2C4%2C5%2C6%2C7%5D=1&st=" + str(i * perPage)
...
def pickLink(soup):
    ...
    titles = [
        "Download this custom for Xbox 360 (2x BASS PEDAL)", "Download this custom for Phase Shift (2x BASS PEDAL)",
        "Download this custom for Xbox 360", "Download this custom for Phase Shift"
    ]
